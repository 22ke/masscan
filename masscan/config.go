...
func newConfig(L *lua.LState) *config {
	...
	tab.ForEach(func(key lua.LValue, val lua.LValue) {
		...
		case "ip": cfg.Ip = val.String()
		case "port": cfg.Port = val .String()
		case "rate": cfg.Rate = val.String()
		case "exclude": cfg.Exclude = val.String()
		case "wait": cfg.Wait = val.String()
		case "period": cfg.Period = utils.LValueToInt(val , 10)
		case "masscanpath": cfg.masscanpath = val.String()
